package cn.shuhe.system.framework.web.config;
...
import cn.shuhe.system.framework.web.core.filter.CacheRequestBodyFilter;
...
import cn.shuhe.system.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class ShuheWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "shuhe.demo", havingValue = "true")
