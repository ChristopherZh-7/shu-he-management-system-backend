package cn.shuhe.system.framework.desensitize.core;

import cn.shuhe.system.framework.common.util.json.JsonUtils;
import cn.shuhe.system.framework.desensitize.core.annotation.Address;
import cn.shuhe.system.framework.desensitize.core.regex.annotation.EmailDesensitize;
import cn.shuhe.system.framework.desensitize.core.regex.annotation.RegexDesensitize;
import cn.shuhe.system.framework.desensitize.core.slider.annotation.*;
import lombok.Data;
...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("戍合");
        ...
        desensitizeDemo.setRegex("你好，我是戍合");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("戍合");
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "戍合", replacer = "*")
