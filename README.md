...
| 【精简版】[shuhe-boot-mini](https://gitee.com/shuhecode/shuhe-boot-mini) | [`master`](https://gitee.com/shuhecode/shuhe-boot-mini/tree/master/) 分支   | [`master-jdk17`](https://gitee.com/shuhecode/shuhe-boot-mini/tree/master-jdk17/) 分支   |
...
![架构演进](/.image/common/shuhe-roadmap.png)
...
| [shuhe-cloud](https://gitee.com/zhijiantianya/shuhe-cloud)      | [![Gitee star](https://gitee.com/zhijiantianya/shuhe-cloud/badge/star.svg?theme=white)](https://gitee.com/zhijiantianya/shuhe-cloud) [![GitHub stars](https://img.shields.io/github/stars/YunaiV/shuhe-cloud.svg?style=social&label=Stars)](https://github.com/YunaiV/shuhe-cloud)               | 基于 Spring Cloud 微服务架构       |
| [Spring-Boot-Labs](https://gitee.com/shuhecode/SpringBoot-Labs) | [![Gitee star](https://gitee.com/shuhecode/SpringBoot-Labs/badge/star.svg?theme=white)](https://gitee.com/zhijiantianya/shuhe-cloud) [![GitHub stars](https://img.shields.io/github/stars/shuhecode/SpringBoot-Labs.svg?style=social&label=Stars)](https://github.com/shuhecode/SpringBoot-Labs) | 系统学习 Spring Boot & Cloud 专栏 |

### 前端项目

| 项目                                                                         | Star                                                                                                                                                                                                                                                                                                                     | 简介                                     |
|----------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|
| [shuhe-ui-admin-vue3](https://gitee.com/shuhecode/shuhe-ui-admin-vue3)     | [![Gitee star](https://gitee.com/shuhecode/shuhe-ui-admin-vue3/badge/star.svg?theme=white)](https://gitee.com/shuhecode/shuhe-ui-admin-vue3) [![GitHub stars](https://img.shields.io/github/stars/shuhecode/shuhe-ui-admin-vue3.svg?style=social&label=Stars)](https://github.com/shuhecode/shuhe-ui-admin-vue3)         | 基于 Vue3 + element-plus 实现的管理后台         |
| [shuhe-ui-admin-vben](https://gitee.com/shuhecode/shuhe-ui-admin-vben)     | [![Gitee star](https://gitee.com/shuhecode/shuhe-ui-admin-vben/badge/star.svg?theme=white)](https://gitee.com/shuhecode/shuhe-ui-admin-vben) [![GitHub stars](https://img.shields.io/github/stars/shuhecode/shuhe-ui-admin-vben.svg?style=social&label=Stars)](https://github.com/shuhecode/shuhe-ui-admin-vben)         | 基于 Vue3 + vben(ant-design-vue) 实现的管理后台 |
| [shuhe-mall-uniapp](https://gitee.com/shuhecode/shuhe-mall-uniapp)         | [![Gitee star](https://gitee.com/shuhecode/shuhe-mall-uniapp/badge/star.svg?theme=white)](https://gitee.com/shuhecode/shuhe-mall-uniapp) [![GitHub stars](https://img.shields.io/github/stars/shuhecode/shuhe-mall-uniapp.svg?style=social&label=Stars)](https://github.com/shuhecode/shuhe-mall-uniapp)                 | 基于 uni-app 实现的商城小程序                    |
| [shuhe-ui-admin-vue2](https://gitee.com/shuhecode/shuhe-ui-admin-vue2)     | [![Gitee star](https://gitee.com/shuhecode/shuhe-ui-admin-vue2/badge/star.svg?theme=white)](https://gitee.com/shuhecode/shuhe-ui-admin-vue2) [![GitHub stars](https://img.shields.io/github/stars/shuhecode/shuhe-ui-admin-vue2.svg?style=social&label=Stars)](https://github.com/shuhecode/shuhe-ui-admin-vue2)         | 基于 Vue2 + element-ui 实现的管理后台           |
| [shuhe-ui-admin-uniapp](https://gitee.com/shuhecode/shuhe-ui-admin-uniapp) | [![Gitee star](https://gitee.com/shuhecode/shuhe-ui-admin-uniapp/badge/star.svg?theme=white)](https://gitee.com/shuhecode/shuhe-ui-admin-uniapp) [![GitHub stars](https://img.shields.io/github/stars/shuhecode/shuhe-ui-admin-uniapp.svg?style=social&label=Stars)](https://github.com/shuhecode/shuhe-ui-admin-uniapp) | 基于 Vue2 + element-ui 实现的管理后台           |
| [shuhe-ui-go-view](https://gitee.com/shuhecode/shuhe-ui-go-view)           | [![Gitee star](https://gitee.com/shuhecode/shuhe-ui-go-view/badge/star.svg?theme=white)](https://gitee.com/shuhecode/shuhe-ui-go-view) [![GitHub stars](https://img.shields.io/github/stars/shuhecode/shuhe-ui-go-view.svg?style=social&label=Stars)](https://github.com/shuhecode/shuhe-ui-go-view)                     | 基于 Vue3 + naive-ui 实现的大屏报表             |
...
| 项目                    | 说明                 |
|-----------------------|--------------------|
| `shuhe-dependencies`  | Maven 依赖版本管理       |
| `shuhe-framework`     | Java 框架拓展          |
| `shuhe-server`        | 管理后台 + 用户 APP 的服务端 |
| `shuhe-module-system` | 系统功能的 Module 模块    |
| `shuhe-module-member` | 会员中心的 Module 模块    |
| `shuhe-module-infra`  | 基础设施的 Module 模块    |
| `shuhe-module-bpm`    | 工作流程的 Module 模块    |
| `shuhe-module-pay`    | 支付系统的 Module 模块    |
| `shuhe-module-mall`   | 商城系统的 Module 模块    |
| `shuhe-module-erp`    | ERP 系统的 Module 模块  |
| `shuhe-module-crm`    | CRM 系统的 Module 模块  |
| `shuhe-module-ai`     | AI 大模型的 Module 模块  |
| `shuhe-module-mp`     | 微信公众号的 Module 模块   |
| `shuhe-module-report` | 大屏报表 Module 模块     |
