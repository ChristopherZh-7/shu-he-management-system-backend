package cn.shuhe.system.module.erp.controller.admin.stock.vo.out;
...
import static cn.shuhe.system.module.erp.enums.DictTypeConstants.AUDIT_STATUS;
...
public class ErpStockOutRespVO {
    ...
    @Schema(description = "客户名称", example = "戍合")
    @ExcelProperty("客户名称")
    ...
    @Schema(description = "创建人", example = "戍合")
    private String creator;
    @Schema(description = "创建人名称", example = "戍合")
