...
import cn.shuhe.system.framework.test.core.util.AssertUtils;
import cn.shuhe.system.framework.test.core.util.RandomUtils;
import cn.shuhe.system.module.bpm.controller.admin.definition.vo.group.BpmUserGroupSaveReqVO;
import cn.shuhe.system.module.bpm.controller.admin.definition.vo.group.BpmUserGroupPageReqVO;
import cn.shuhe.system.module.bpm.dal.dataobject.definition.BpmUserGroupDO;
import cn.shuhe.system.module.bpm.dal.mysql.definition.BpmUserGroupMapper;
...
import static cn.shuhe.system.module.bpm.enums.ErrorCodeConstants.USER_GROUP_NOT_EXISTS;
...
public class BpmUserGroupServiceTest extends BaseDbUnitTest {
    ...
    public void testGetUserGroupPage() {
       ...
       // 测试 name 不匹配
       userGroupMapper.insert(cloneIgnoreId(dbUserGroup, o -> o.setName("戍合")));
       // 测试 status 不匹配
