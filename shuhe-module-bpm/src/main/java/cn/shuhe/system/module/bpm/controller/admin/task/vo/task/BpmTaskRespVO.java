package cn.shuhe.system.module.bpm.controller.admin.task.vo.task;
...
public class BpmTaskRespVO {
    ...
    @Schema(description = "任务名字", requiredMode = Schema.RequiredMode.REQUIRED, example = "戍合")
    private String name;
    ...
    public static class ProcessInstance {
        ...
        @Schema(description = "流程实例名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "戍合")
        private String name;
        ...
        private List<KeyValue<String, String>> summary; // 流程表单按表单字段；业务表单按流程变量
