...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "cn.shuhe";
    private static final String ARTIFACT_ID = "shuhe";
    private static final String PACKAGE_NAME = "cn.shuhe.system";
    private static final String TITLE = "戍合管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "cn.shuhe";
        String artifactIdNew = "shuhe";
        String packageNameNew = "cn.shuhe.system";
        String titleNew = "戍合管理系统";
