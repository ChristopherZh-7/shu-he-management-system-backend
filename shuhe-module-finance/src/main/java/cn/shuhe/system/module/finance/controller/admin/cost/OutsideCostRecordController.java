...
@RestController
@RequestMapping("/finance/outside-cost")
@Validated
public class OutsideCostRecordController {
    ...
    @PreAuthorize("@ss.hasPermission('finance:outside-cost:query')")
    ...
    @PreAuthorize("@ss.hasPermission('finance:outside-cost:assign')")
    ...
    @PreAuthorize("@ss.hasPermission('finance:outside-cost:fill')")
