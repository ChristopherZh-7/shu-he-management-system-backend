...
public interface SecurityOperationContractInfoMapper {
    ...
    @Select("SELECT " +
            ...
            "  GROUP BY fa1.contract_id" +
            ") fa_sum ON fa_sum.contract_id = soc.contract_id " +
