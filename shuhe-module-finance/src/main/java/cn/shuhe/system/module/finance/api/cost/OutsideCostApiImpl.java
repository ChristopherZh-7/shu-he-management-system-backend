package cn.shuhe.system.module.finance.api.cost;

import cn.shuhe.system.module.finance.dal.dataobject.cost.OutsideCostRecordDO;
...
import cn.shuhe.system.module.finance.dal.mysql.cost.OutsideRequestInfoMapper;
import cn.shuhe.system.module.system.dal.mysql.dept.DeptMapper;
import cn.shuhe.system.module.finance.service.cost.OutsideCostRecordService;
    ...
    public void sendAssignNotifyToTargetDeptLeader(Long outsideRequestId) {
        try {
            ...
            String content = String.format(
                    ...
                    outsideCostRecordService.resolveServiceTypeLabel(record.getDeptType(), record.getServiceType()),
