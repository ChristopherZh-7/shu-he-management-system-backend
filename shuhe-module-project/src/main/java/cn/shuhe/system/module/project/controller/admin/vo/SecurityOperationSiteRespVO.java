...
@Schema(description = "管理后台 - 安全运营驻场点 Response VO")
@Data
public class SecurityOperationSiteRespVO {
    ...
    private List<SecurityOperationMemberRespVO> members;

    @Schema(description = "当前驻场人员数量", example = "2")
