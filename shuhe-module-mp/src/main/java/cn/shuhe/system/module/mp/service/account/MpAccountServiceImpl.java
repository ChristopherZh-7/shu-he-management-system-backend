package cn.shuhe.system.module.mp.service.account;
...
import cn.shuhe.system.module.mp.controller.admin.account.vo.MpAccountCreateReqVO;
import cn.shuhe.system.module.mp.controller.admin.account.vo.MpAccountPageReqVO;
import cn.shuhe.system.module.mp.controller.admin.account.vo.MpAccountUpdateReqVO;
import cn.shuhe.system.module.mp.convert.account.MpAccountConvert;
import cn.shuhe.system.module.mp.dal.dataobject.account.MpAccountDO;
import cn.shuhe.system.module.mp.dal.mysql.account.MpAccountMapper;
import cn.shuhe.system.module.mp.enums.ErrorCodeConstants;
...
import static cn.shuhe.system.framework.common.util.collection.CollectionUtils.getMaxValue;
import static cn.shuhe.system.module.system.enums.ErrorCodeConstants.USER_USERNAME_EXISTS;
...
public class MpAccountServiceImpl implements MpAccountService {
    ...
    public void initLocalCache() {
        ...
        try {
            ...
            log.error("[微信公众号 shuhe-module-mp - 表结构未导入][参考 https://doc.iocoder.cn/mp/build/ 开启]");
        }
