package cn.shuhe.system.module.infra.controller.admin.codegen;
...
import cn.shuhe.system.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import cn.shuhe.system.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import cn.shuhe.system.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import cn.shuhe.system.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import cn.shuhe.system.module.infra.convert.codegen.CodegenConvert;
...
import cn.shuhe.system.module.infra.service.codegen.CodegenService;
...
import static cn.shuhe.system.framework.security.core.util.SecurityFrameworkUtils.getLoginUserNickname;
import static cn.shuhe.system.module.infra.framework.file.core.utils.FileTypeUtils.writeAttachment;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "shuhe"),
            @Parameter(name = "comment", description = "描述，模糊匹配", example = "戍合")
    })
