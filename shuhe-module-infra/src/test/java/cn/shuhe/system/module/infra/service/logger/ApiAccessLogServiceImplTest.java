...
import cn.shuhe.system.framework.common.biz.infra.logger.dto.ApiAccessLogCreateReqDTO;
...
import cn.shuhe.system.module.infra.controller.admin.logger.vo.apiaccesslog.ApiAccessLogPageReqVO;
import cn.shuhe.system.module.infra.dal.dataobject.logger.ApiAccessLogDO;
import cn.shuhe.system.module.infra.dal.mysql.logger.ApiAccessLogMapper;
...
import static cn.shuhe.system.framework.common.util.date.LocalDateTimeUtils.*;
...
public class ApiAccessLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiAccessLogPage() {
        ApiAccessLogDO apiAccessLogDO = randomPojo(ApiAccessLogDO.class, o -> {
            ...
            o.setApplicationName("shuhe-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("shuhe-test");
