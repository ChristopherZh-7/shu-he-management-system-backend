...
$CFG = @{
    ...
    DbName         = "shuhe-ms"
    JavaHome       = "C:\Users\Christopher\.jdks\ms-17.0.18"
    MvnCmd         = "C:\Program Files\JetBrains\IntelliJ IDEA 2026.1\plugins\maven\lib\maven3\bin\mvn.cmd"
    BackendDir     = $PSScriptRoot
    FrontendDir    = "C:\Users\Christopher\WebstormProjects\shu-he-management-system-frontend"
