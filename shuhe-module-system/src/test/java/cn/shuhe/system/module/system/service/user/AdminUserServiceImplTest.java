package cn.shuhe.system.module.system.service.user;
...
import cn.shuhe.system.framework.common.util.collection.ArrayUtils;
...
import cn.shuhe.system.module.infra.api.config.ConfigApi;
import cn.shuhe.system.module.infra.api.file.FileApi;
...
import cn.shuhe.system.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import cn.shuhe.system.module.system.controller.admin.user.vo.user.UserImportRespVO;
...
import cn.shuhe.system.module.system.enums.common.SexEnum;
import cn.shuhe.system.module.system.service.dept.DeptService;
import cn.shuhe.system.module.system.service.dept.PostService;
...
import static cn.shuhe.system.framework.common.util.collection.SetUtils.asSet;
...
import static cn.shuhe.system.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("shuheyuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("shuheyuanma");
        ...
        assertEquals("shuheyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("shuheyuanma"))).thenReturn("java");
