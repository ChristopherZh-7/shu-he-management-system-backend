package cn.shuhe.system.module.system.service.mail;
...
import cn.shuhe.system.module.system.controller.admin.mail.vo.template.MailTemplateSaveReqVO;
import cn.shuhe.system.module.system.controller.admin.mail.vo.template.MailTemplatePageReqVO;
import cn.shuhe.system.module.system.dal.dataobject.mail.MailTemplateDO;
import cn.shuhe.system.module.system.dal.mysql.mail.MailTemplateMapper;
...
import static cn.shuhe.system.module.system.enums.ErrorCodeConstants.MAIL_TEMPLATE_NOT_EXISTS;
...
public class MailTemplateServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMailTemplatePage() {
        ...
        // 测试 name 不匹配
        mailTemplateMapper.insert(cloneIgnoreId(dbMailTemplate, o -> o.setName("戍合")));
        // 测试 code 不匹配
