package cn.shuhe.system.module.system.enums;
...
public interface ErrorCodeConstants {
    ...
    // ========== 钉钉部分 1-002-029-000 ==========
    // TODO 待办：请将下面的错误码复制到 shuhe-module-system 模块的 ErrorCodeConstants 类中。注意，请给“TODO 补充编号”设置一个错误码编号！！！
// ========== 钉钉数据映射 TODO 补充编号 ==========
