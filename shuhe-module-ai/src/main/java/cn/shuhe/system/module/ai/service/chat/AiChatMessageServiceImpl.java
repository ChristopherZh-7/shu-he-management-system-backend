package cn.shuhe.system.module.ai.service.chat;
...
import cn.shuhe.system.module.ai.controller.admin.chat.vo.message.AiChatMessagePageReqVO;
import cn.shuhe.system.module.ai.controller.admin.chat.vo.message.AiChatMessageRespVO;
import cn.shuhe.system.module.ai.controller.admin.chat.vo.message.AiChatMessageSendReqVO;
import cn.shuhe.system.module.ai.controller.admin.chat.vo.message.AiChatMessageSendRespVO;
import cn.shuhe.system.module.ai.dal.dataobject.chat.AiChatConversationDO;
import cn.shuhe.system.module.ai.dal.dataobject.chat.AiChatMessageDO;
import cn.shuhe.system.module.ai.dal.dataobject.knowledge.AiKnowledgeDocumentDO;
import cn.shuhe.system.module.ai.dal.dataobject.model.AiChatRoleDO;
import cn.shuhe.system.module.ai.dal.dataobject.model.AiModelDO;
import cn.shuhe.system.module.ai.dal.dataobject.model.AiToolDO;
import cn.shuhe.system.module.ai.dal.mysql.chat.AiChatMessageMapper;
import cn.shuhe.system.module.ai.enums.ErrorCodeConstants;
import cn.shuhe.system.module.ai.enums.model.AiPlatformEnum;
import cn.shuhe.system.module.ai.framework.ai.core.webserch.AiWebSearchClient;
import cn.shuhe.system.module.ai.framework.ai.core.webserch.AiWebSearchRequest;
import cn.shuhe.system.module.ai.framework.ai.core.webserch.AiWebSearchResponse;
import cn.shuhe.system.module.ai.service.knowledge.AiKnowledgeDocumentService;
import cn.shuhe.system.module.ai.service.knowledge.AiKnowledgeSegmentService;
import cn.shuhe.system.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchReqBO;
import cn.shuhe.system.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchRespBO;
import cn.shuhe.system.module.ai.service.model.AiChatRoleService;
import cn.shuhe.system.module.ai.service.model.AiModelService;
import cn.shuhe.system.module.ai.service.model.AiToolService;
import cn.shuhe.system.module.ai.util.AiUtils;
import cn.shuhe.system.module.ai.util.FileTypeUtils;
...
import static cn.shuhe.system.module.ai.enums.ErrorCodeConstants.CHAT_CONVERSATION_NOT_EXISTS;
import static cn.shuhe.system.module.ai.enums.ErrorCodeConstants.CHAT_MESSAGE_NOT_EXIST;
...
public class AiChatMessageServiceImpl implements AiChatMessageService {
    ...
    @Autowired(required = false) // 由于 shuhe.ai.web-search.enable 配置项，可以关闭 AiWebSearchClient 的功能，所以这里只能不强制注入
    private AiWebSearchClient webSearchClient;

    @SuppressWarnings("SpringJavaAutowiredFieldsWarningInspection")
    @Autowired(required = false) // 由于 shuhe.ai.mcp.client.enable 配置项，可以关闭 McpSyncClient 的功能，所以这里只能不强制注入
    ...
    public Flux<CommonResult<AiChatMessageSendRespVO>> sendChatMessageStream(AiChatMessageSendReqVO sendReqVO,
        ...
        // 1.2 校验模型
        AiModelDO model = modelService.validateModel(conversation.getModelId());
        StreamingChatModel chatModel = modelService.getChatModel(model.getId());
