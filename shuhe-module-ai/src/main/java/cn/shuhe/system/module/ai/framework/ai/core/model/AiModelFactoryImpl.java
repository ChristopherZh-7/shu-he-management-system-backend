package cn.shuhe.system.module.ai.framework.ai.core.model;
...
import cn.shuhe.system.framework.common.util.spring.SpringUtils;
import cn.shuhe.system.module.ai.enums.model.AiPlatformEnum;
import cn.shuhe.system.module.ai.framework.ai.config.AiAutoConfiguration;
import cn.shuhe.system.module.ai.framework.ai.config.ShuheAiProperties;
...
import cn.shuhe.system.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageApi;
import cn.shuhe.system.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageModel;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            ShuheAiProperties.Midjourney properties = SpringUtil.getBean(ShuheAiProperties.class)
                    .getMidjourney();
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#douBaoChatClient(ShuheAiProperties)}
     */
    private ChatModel buildDouBaoChatModel(String apiKey) {
        ShuheAiProperties.DouBao properties = new ShuheAiProperties.DouBao()
                .setApiKey(apiKey);
        return new AiAutoConfiguration().buildDouBaoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#hunYuanChatClient(ShuheAiProperties)}
     */
    private ChatModel buildHunYuanChatModel(String apiKey, String url) {
        ShuheAiProperties.HunYuan properties = new ShuheAiProperties.HunYuan()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildHunYuanChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#siliconFlowChatClient(ShuheAiProperties)}
     */
    private ChatModel buildSiliconFlowChatModel(String apiKey) {
        ShuheAiProperties.SiliconFlow properties = new ShuheAiProperties.SiliconFlow()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#xingHuoChatClient(ShuheAiProperties)}
     */
    private static XingHuoChatModel buildXingHuoChatModel(String key) {
        ...
        ShuheAiProperties.XingHuo properties = new ShuheAiProperties.XingHuo()
                .setAppKey(keys.get(0)).setSecretKey(keys.get(1));
        return new AiAutoConfiguration().buildXingHuoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#baiChuanChatClient(ShuheAiProperties)}
     */
    private BaiChuanChatModel buildBaiChuanChatModel(String apiKey) {
        ShuheAiProperties.BaiChuan properties = new ShuheAiProperties.BaiChuan()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#buildGeminiChatClient(ShuheAiProperties.Gemini)}
     */
    private static GeminiChatModel buildGeminiChatModel(String apiKey) {
        ShuheAiProperties.Gemini properties = SpringUtil.getBean(ShuheAiProperties.class)
    ...
    private ChatModel buildGrokChatModel(String apiKey,String url) {
        ShuheAiProperties.Grok properties = new ShuheAiProperties.Grok()
                .setBaseUrl(url)
                .setApiKey(apiKey);
